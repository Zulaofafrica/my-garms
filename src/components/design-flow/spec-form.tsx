    ...
    return (
        <div className="space-y-10 animate-in slide-in-from-right-8 fade-in duration-500 max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
                ...
                {fabricSource === 'own' && (
                    <div className="bg-amber-500/10 border border-amber-500/30 rounded-lg p-4 flex flex-col gap-3 animate-in fade-in slide-in-from-top-2">
                        ...
                        <div className="pl-8 text-sm text-amber-200/60 italic">
                            💡 Tip: If you have a picture of your fabric, please upload it in the "Inspiration Images" section in the previous step so the designer can see what they'll be working with!
                        </div>
                    </div>
                )}
            </div>
